...
(
    ...
    logseconds => 60,
    wlograte   => 5,
    wservice   => undef, # (no online weather service unless specified)
    wkey       => undef, # (only required for some weather services)
    wlocation  => undef, # (only required if using an online weather service)
    wunits     => 'C',
    debug      => 0,
    verbose    => 0,
    logfile    => '/var/log/heatmiser'
